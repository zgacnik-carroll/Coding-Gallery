...
class Game:
    ...
    def wave_cleared(self):
        """Return True if no monsters remain on the board."""
        return len(self.board.monsters) == 0
    ...
    def place_tower_at(self, tower, lane, col):
        """
        Place a tower at a specific board location.
